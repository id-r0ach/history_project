...
export const ERA_THEMES: Record<string, EraTheme> = {
  СССР: {
    ...
    badgeClass: "border-[color:var(--theme-accent-soft)] bg-[var(--theme-badge)] text-[var(--theme-accent-2)]",
  ...
  Романовы: {
    ...
    accentClass: "text-[var(--theme-accent)]",
    badgeClass: "border-[color:var(--theme-accent-soft)] bg-[var(--theme-badge)] text-[var(--theme-accent)]",
