...
# Тарифы
# ---------------------------------------------------------------------------
_RUB_PER_INPUT_TOKEN  = 230.0  / 1_000_000
_RUB_PER_OUTPUT_TOKEN = 1152.0 / 1_000_000
_RUB_PER_TTS_CHAR     = 180.0  / 1_000_000
...
class BalanceTracker:
    def __init__(self, path: Path, initial_balance: float = 500.0) -> None:
        self._path = path
        # Используем RLock — реентерабельный, не вызывает дедлок при вложенных вызовах
